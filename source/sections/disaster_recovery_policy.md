...
The Provata Health Contingency Plan establishes procedures to recover Provata Health following a disruption resulting from a disaster. This Disaster Recovery Policy is maintained by the Provata Health Security Officer and Privacy Officer.
...
2. Identify the activities, resources, and procedures needed to carry out Provata Health processing requirements during prolonged interruptions to normal operations.
3. Identify and define the impact of interruptions to Provata Health systems.
4. Assign responsibilities to designated personnel and provide guidance for recovering Provata Health during prolonged periods of interruption to normal operations. 
5. Ensure coordination with other Provata Health staff who will participate in the contingency planning strategies.
6. Ensure coordination with external points of contact and vendors who will participate in the contingency planning strategies. 

This Provata Health Contingency Plan has been developed as required under the Office of Management and Budget (OMB) Circular A-130, Management of Federal Information Resources, Appendix III, November 2000, and the Health Insurance Portability and Accountability Act (HIPAA) Final Security Rule, Section §164.308(a)(7), which requires the establishment and implementation of procedures for responding to events that damage systems containing electronic protected health information. 

This Provata Health Contingency Plan is created under the legislative requirements set forth in the Federal Information Security Management Act (FISMA) of 2002 and the guidelines established by the National Institute of Standards and Technology (NIST) Special Publication (SP) 800-34, titled "Contingency Planning Guide for Information Technology Systems" dated June 2002.
 
The Provata Health Contingency Plan also complies with the following federal and departmental policies:
...
Provata Health defined two categories of systems from a disaster recovery perspective.
...
The following order of succession to ensure that decision-making authority for the Provata Health Contingency Plan is uninterrupted. The Security Officer, Aaron Goldberg, is responsible for ensuring the safety of personnel and the execution of procedures documented within this Provata Health Contingency Plan. If the CTO and VP of Engineering are unable to function as the overall authority or chooses to delegate this responsibility to a successor, the CEO or CPO shall function as that authority. To provide contact initiation should the contingency plan need to be initiated, please use the contact list below.
...
This phase addresses the initial actions taken to detect and assess damage inflicted by a disruption to Provata Health. Based on the assessment of the Event, sometimes according to the Provata Health Incident Response Policy, the Contingency Plan may be activated by either the CTO or VP of Engineering.
...
* The Provata Health Contingency Plan is to be activated if one or more of the following criteria are met:
	...
	* Other criteria, as appropriate and as defined by Provata Health.
...
The following procedures are for recovering the Provata Health infrastructure at the alternate site. Procedures are outlined per team required. Each procedure should be executed in the sequence it is presented to maintain efficient operations. 

Recovery Goal: The goal is to rebuild Provata Health infrastructure to a production state.

The tasks outlines below are not sequential and some can be run in parallel.

1. Contact Partners and Customers affected - Web Services
2. Assess damage to the environment - Web Services
3. Begin replication of new environment using automated and tested scrips, currently Salt. At this point it is determined whether to recover in AWS. - Dev Ops
...
This section discusses activities necessary for restoring Provata Health operations at the original or new site. The goal is to restore full operations within 24 hours of a disaster or outage. When the hosted data center at the original or new site has been restored, Provata Health operations at the alternate site may be transitioned back. The goal is to provide a seamless transition of operations from the alternate site to the computer center.
...
If the Provata Health environment is moved back to the original site from the alternative site, all hardware used at the alternate site should be handled and disposed of according to the Provata Health Media Disposal Policy. 
